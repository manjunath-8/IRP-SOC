...
#define FIREBASE_HOST "example.firebaseio.com"              // the project name address from firebase id
#define FIREBASE_AUTH "your secret key from firebase"       // the secret key generated from firebase
#define WIFI_SSID "example"                                              // your ssid                     
#define WIFI_PASSWORD "example@123456"                                   //password
